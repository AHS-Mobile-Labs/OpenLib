...
description: Learn how users find apps through search, categories, tags, rankings, trending pages, and alternative pages.
...
> [!NOTE]
> Discovery pages should not become popularity-only lists. OpenLib should still make room for specialized tools that solve narrow problems well.
